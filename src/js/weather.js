export default async function weather() {
  try {
    ...
    const conditionGifApi = await fetch(`https://api.giphy.com/v1/gifs/search?api_key=7DOBtFE3PDUY88lbr92uY85Agd1c5YbD&limit=1&q=${weatherObject.weather[0].description}`);
